...
class Constants091
{
    ...
    public static $GLOBAL_METHOD_NAMES = array(
        ...
        '40,10' => 'ExchangeFactory.declare',
        '40,11' => 'ExchangeFactory.declare_ok',
        '40,20' => 'ExchangeFactory.delete',
        '40,21' => 'ExchangeFactory.delete_ok',
        '40,30' => 'ExchangeFactory.bind',
        '40,31' => 'ExchangeFactory.bind_ok',
        '40,40' => 'ExchangeFactory.unbind',
        '40,51' => 'ExchangeFactory.unbind_ok',
        '50,10' => 'QueueFactory.declare',
        '50,11' => 'QueueFactory.declare_ok',
        '50,20' => 'QueueFactory.bind',
        '50,21' => 'QueueFactory.bind_ok',
        '50,30' => 'QueueFactory.purge',
        '50,31' => 'QueueFactory.purge_ok',
        '50,40' => 'QueueFactory.delete',
        '50,41' => 'QueueFactory.delete_ok',
        '50,50' => 'QueueFactory.unbind',
        '50,51' => 'QueueFactory.unbind_ok',
        '60,10' => 'Basic.qos',
        '60,11' => 'Basic.qos_ok',
        '60,20' => 'Basic.consume',
